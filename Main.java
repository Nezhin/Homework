...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" Fruits are added ");

        System.out.println("Box 1(Oranges): "+or.getWeight());
        System.out.println("Box 2(Oranges): "+or1.getWeight());
        System.out.println("Box 3(Apples): "+ap.getWeight());
        System.out.println("Box 4(Apples): "+ap1.getWeight());

        System.out.println("Box 1 equals box 3: "+or.compare(ap));
        System.out.println("Box 2 equals box 4: "+or1.compare(ap1));
        System.out.println("Boxes are compared");

        or.pourTo(or1);
        ap.pourTo(ap1);
        System.out.println(" Fruits are changed ");
